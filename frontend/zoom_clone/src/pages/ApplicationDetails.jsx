    ...
    return (
        <Box sx={{ minHeight: "100vh", backgroundColor: "#f8f9fa", color: "#101828" }}>
            ...
            <Container maxWidth="md" sx={{ py: { xs: 5, md: 8 } }}>
                ...
                <Typography variant="h1" sx={{ fontSize: { xs: 34, md: 48 }, fontWeight: 800, lineHeight: 1.15, mb: 2 }}>
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "1fr 1fr" }, gap: 2.5 }}>
                    {features.map((feature) => (
                        <Box key={feature.title} sx={{ backgroundColor: "#ffffff", border: "1px solid #eaecf0", borderRadius: "12px", p: 3 }}>
                            ...
                            <Typography sx={{ fontWeight: 700, fontSize: 17, mb: 1 }}>{feature.title}</Typography>
                ...
                <Divider sx={{ my: 5 }} />
                <Typography variant="h2" sx={{ fontSize: 26, fontWeight: 700, mb: 1.5 }}>Who is SyncLearn for?</Typography>
